                ...
                <div class="border w-80 shadow-lg">
                    ...
                    <div>
                        <a class="w-32 h-20 block" href="https://detailed-video-29b30.web.app/detailed%20video.mp4">
                            <img class="w-32 h-20 mx-3" src="https://cdn.glitch.global/2d202796-5635-411e-af9e-76219e16545d/download.jfif?v=1695952401347" alt="">
                        </a>
                    </div>
            ...
            <div class="border md:block hidden lg:block block mx-72 mt-9 w-[630px]">
                ...
                <div>
                    <a class="w-[120px] h-[80px] block mx-3" href="https://detailed-video-29b30.web.app/detailed%20video.mp4">
                        <img src="https://cdn.glitch.global/2d202796-5635-411e-af9e-76219e16545d/download.jfif?v=1695952401347" alt="">
                    </a>
                </div>
                <div>
                ...
                <div class="border mx-3 h-10 mt-4 bg-[#f5f6f7]">
                    <div class="flex justify-end mx-2">
                        <button class="border h-7 w-16  bg-[#4267b2] text-white shadow-2xl mt-[0.30rem] font-serif font-thin text-xs hover:bg-blue-500" onclick="onLogin()" id="delete-btn">Submit
  </button>
                    </div>
                </div>
                <div class="mt-4"></div>
